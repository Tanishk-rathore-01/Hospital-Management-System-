...
export const appointments: Appointment[] = [
  {
    ...
    doctorName: 'Dr. Amit Sharma', department: 'Cardiology', date: '2025-07-15',
    time: '09:00 AM', type: 'Consultation', status: 'Scheduled', notes: 'Regular heart checkup', fee: 250
  },
  {
    id: 'A002', patientId: 'P002', patientName: 'Priya Sharma', doctorId: 'D003',
    doctorName: 'Dr. Rahul Verma', department: 'Pediatrics', date: '2025-07-15',
    time: '10:30 AM', type: 'Follow-up', status: 'In Progress', notes: 'Follow up on flu treatment', fee: 150
  },
  {
    id: 'A003', patientId: 'P003', patientName: 'Rohit Singh', doctorId: 'D002',
    doctorName: 'Dr. Priya Iyer', department: 'Neurology', date: '2025-07-14',
    time: '02:00 PM', type: 'Checkup', status: 'Completed', notes: 'Migraine assessment', fee: 300
  },
  {
    id: 'A004', patientId: 'P004', patientName: 'Ananya Gupta', doctorId: 'D005',
    doctorName: 'Dr. Neha Kapoor', department: 'Dermatology', date: '2025-07-16',
    time: '11:00 AM', type: 'Consultation', status: 'Scheduled', notes: 'Skin rash examination', fee: 180
  },
  {
    id: 'A005', patientId: 'P005', patientName: 'Vikram Patel', doctorId: 'D004',
    doctorName: 'Dr. Arjun Mehta', department: 'Orthopedics', date: '2025-07-13',
    time: '03:30 PM', type: 'Surgery', status: 'Completed', notes: 'Knee replacement surgery', fee: 8500
  },
  {
    id: 'A006', patientId: 'P006', patientName: 'Neha Rao', doctorId: 'D001',
    doctorName: 'Dr. Amit Sharma', department: 'Cardiology', date: '2025-07-17',
    time: '09:30 AM', type: 'Emergency', status: 'Scheduled', notes: 'Chest pain complaint', fee: 450
  },
  {
    id: 'A007', patientId: 'P007', patientName: 'Suresh Iyer', doctorId: 'D006',
    doctorName: 'Dr. Sunita Rao', department: 'Oncology', date: '2025-07-15',
    time: '01:00 PM', type: 'Follow-up', status: 'Scheduled', notes: 'Chemotherapy follow-up', fee: 350
  },
  {
    id: 'A008', patientId: 'P008', patientName: 'Kavita Menon', doctorId: 'D003',
    doctorName: 'Dr. Rahul Verma', department: 'Pediatrics', date: '2025-07-14',
    time: '04:00 PM', type: 'Consultation', status: 'Cancelled', notes: 'Child vaccination', fee: 120
  },
];
...
export const medicalRecords: MedicalRecord[] = [
  {
    ...
    doctorName: 'Dr. Amit Sharma', date: '2025-07-10',
    ...
    labResults: [
      { test: 'Blood Pressure', result: '158/98 mmHg', normalRange: '120/80 mmHg', status: 'Abnormal', date: '2025-07-10' },
      { test: 'Cholesterol', result: '245 mg/dL', normalRange: '<200 mg/dL', status: 'Abnormal', date: '2025-07-10' },
      { test: 'Blood Glucose', result: '102 mg/dL', normalRange: '70-100 mg/dL', status: 'Normal', date: '2025-07-10' },
    ],
    notes: 'Patient advised to reduce sodium intake and increase physical activity. Follow up in 4 weeks.',
    followUpDate: '2025-08-10',
    vitals: { bloodPressure: '158/98', heartRate: 88, temperature: 98.6, weight: 185, height: 72, oxygenSaturation: 97 }
  },
  {
    id: 'MR002', patientId: 'P002', patientName: 'Priya Sharma', doctorId: 'D003',
    doctorName: 'Dr. Rahul Verma', date: '2025-07-05',
    ...
    labResults: [
      { test: 'Complete Blood Count', result: 'WBC: 11,200/μL', normalRange: '4,500-11,000/μL', status: 'Abnormal', date: '2025-07-05' },
      { test: 'Throat Culture', result: 'Streptococcus positive', normalRange: 'Negative', status: 'Critical', date: '2025-07-05' },
    ],
    notes: 'Strep throat confirmed. Started antibiotic therapy.',
    followUpDate: '2025-07-15',
    vitals: { bloodPressure: '118/76', heartRate: 96, temperature: 101.2, weight: 135, height: 65, oxygenSaturation: 99 }
  },
  {
    id: 'MR003', patientId: 'P003', patientName: 'Rohit Singh', doctorId: 'D002',
    doctorName: 'Dr. Priya Iyer', date: '2025-07-14',
    ...
    labResults: [
      { test: 'MRI Brain', result: 'No structural abnormalities', normalRange: 'Normal', status: 'Normal', date: '2025-07-12' },
      { test: 'EEG', result: 'Normal brain activity', normalRange: 'Normal', status: 'Normal', date: '2025-07-12' },
    ],
    notes: 'Patient reports 3-4 episodes per month. Trigger diary recommended.',
    followUpDate: '2025-08-14',
    vitals: { bloodPressure: '122/80', heartRate: 72, temperature: 98.4, weight: 168, height: 70, oxygenSaturation: 98 }
  },
];

export const bills: Bill[] = [
  {
    id: 'B001', patientId: 'P001', patientName: 'Rajesh Kumar', date: '2025-07-10',
    dueDate: '2025-07-25', items: [
      { description: 'Cardiology Consultation', category: 'Consultation', quantity: 1, unitPrice: 250, total: 250 },
      { description: 'ECG Test', category: 'Lab Test', quantity: 1, unitPrice: 120, total: 120 },
      { description: 'Blood Panel', category: 'Lab Test', quantity: 1, unitPrice: 85, total: 85 },
      { description: 'Lisinopril 10mg (30 tabs)', category: 'Medication', quantity: 1, unitPrice: 45, total: 45 },
    ],
    subtotal: 500, tax: 40, discount: 50, total: 490, paid: 490,
    status: 'Paid', paymentMethod: 'Insurance', insurance: 'Apollo Munich', insuranceCoverage: 390
  },
  {
    id: 'B002', patientId: 'P005', patientName: 'Vikram Patel', date: '2025-07-13',
    dueDate: '2025-07-28', items: [
      { description: 'Knee Replacement Surgery', category: 'Surgery', quantity: 1, unitPrice: 8500, total: 8500 },
      { description: 'Anesthesia', category: 'Other', quantity: 1, unitPrice: 1200, total: 1200 },
      { description: 'Hospital Room (3 days)', category: 'Room', quantity: 3, unitPrice: 450, total: 1350 },
      { description: 'Post-op Medications', category: 'Medication', quantity: 1, unitPrice: 320, total: 320 },
      { description: 'X-Ray & Imaging', category: 'Lab Test', quantity: 2, unitPrice: 180, total: 360 },
    ],
    subtotal: 11730, tax: 936, discount: 1000, total: 11666, paid: 6000,
    status: 'Partial', paymentMethod: 'Insurance + Cash', insurance: 'Bajaj Allianz', insuranceCoverage: 8500
  },
  {
    id: 'B003', patientId: 'P002', patientName: 'Priya Sharma', date: '2025-07-05',
    dueDate: '2025-07-20', items: [
      { description: 'Pediatric Consultation', category: 'Consultation', quantity: 1, unitPrice: 150, total: 150 },
      { description: 'Throat Culture Test', category: 'Lab Test', quantity: 1, unitPrice: 65, total: 65 },
      { description: 'Amoxicillin 500mg (21 tabs)', category: 'Medication', quantity: 1, unitPrice: 28, total: 28 },
    ],
    subtotal: 243, tax: 19.44, discount: 0, total: 262.44, paid: 262.44,
    status: 'Paid', paymentMethod: 'Credit Card', insurance: 'Max Bupa', insuranceCoverage: 0
  },
  {
    id: 'B004', patientId: 'P007', patientName: 'Suresh Iyer', date: '2025-06-28',
    dueDate: '2025-07-13', items: [
      { description: 'Oncology Consultation', category: 'Consultation', quantity: 1, unitPrice: 350, total: 350 },
      { description: 'Chemotherapy Session', category: 'Other', quantity: 3, unitPrice: 1200, total: 3600 },
      { description: 'Lab Work', category: 'Lab Test', quantity: 1, unitPrice: 245, total: 245 },
    ],
    subtotal: 4195, tax: 335.6, discount: 200, total: 4330.6, paid: 0,
    status: 'Overdue', paymentMethod: 'Pending', insurance: 'New India Assurance', insuranceCoverage: 3000
  },
  {
    id: 'B005', patientId: 'P006', patientName: 'Neha Rao', date: '2025-07-17',
    dueDate: '2025-08-01', items: [
      { description: 'Emergency Consultation', category: 'Consultation', quantity: 1, unitPrice: 450, total: 450 },
      { description: 'Cardiac Monitoring', category: 'Other', quantity: 1, unitPrice: 280, total: 280 },
      { description: 'Emergency Lab Panel', category: 'Lab Test', quantity: 1, unitPrice: 195, total: 195 },
    ],
    subtotal: 925, tax: 74, discount: 0, total: 999, paid: 0,
    status: 'Pending', paymentMethod: 'Pending', insurance: 'HDFC Ergo', insuranceCoverage: 750
  },
];
...
export const medicines: Medicine[] = [
  {
    ...
    manufacturer: 'Lupin Pharma', stock: 450, minStock: 100, unit: 'Tablets', price: 0.45,
  ...
  },
  {
    ...
    manufacturer: 'Sun Pharma', stock: 85, minStock: 100, unit: 'Capsules', price: 0.28,
    expiryDate: '2025-12-15', batchNumber: 'SP2024045', location: 'Shelf B-3', status: 'Low Stock'
  },
  {
    id: 'M003', name: 'Paracetamol 500mg', genericName: 'Acetaminophen', category: 'Analgesic',
    manufacturer: 'GSK', stock: 1200, minStock: 200, unit: 'Tablets', price: 0.08,
  ...
  },
  {
    ...
    manufacturer: 'Cipla', stock: 320, minStock: 80, unit: 'Tablets', price: 0.22,
  ...
  },
  {
    ...
    manufacturer: 'Pfizer', stock: 0, minStock: 60, unit: 'Tablets', price: 1.20,
  ...
  },
  {
    ...
    manufacturer: 'Lupin Pharma', stock: 280, minStock: 75, unit: 'Tablets', price: 0.35,
    expiryDate: '2025-09-30', batchNumber: 'LP2024056', location: 'Shelf A-3', status: 'In Stock'
  },
  {
    id: 'M007', name: 'Omeprazole 20mg', genericName: 'Omeprazole', category: 'PPI',
    manufacturer: 'AstraZeneca', stock: 42, minStock: 100, unit: 'Capsules', price: 0.65,
  ...
  },
  {
    ...
    manufacturer: 'Novartis', stock: 145, minStock: 40, unit: 'Tablets', price: 3.80,
  ...
  },
  {
    ...
    manufacturer: 'Sanofi', stock: 65, minStock: 50, unit: 'Vials', price: 45.00,
    expiryDate: '2025-11-20', batchNumber: 'SA2024067', location: 'Refrigerator R-1', status: 'In Stock'
  },
  {
    id: 'M010', name: 'Ciprofloxacin 500mg', genericName: 'Ciprofloxacin HCl', category: 'Antibiotic',
    manufacturer: 'Bayer', stock: 58, minStock: 80, unit: 'Tablets', price: 0.95,
...
export const pharmacyOrders: PharmacyOrder[] = [
  {
    ...
    doctorName: 'Dr. Amit Sharma', date: '2025-07-10',
    medicines: [
      { medicineId: 'M001', medicineName: 'Lisinopril', quantity: 30, price: 0.45, total: 13.50 },
      { medicineId: 'M006', medicineName: 'Amlodipine 5mg', quantity: 30, price: 0.35, total: 10.50 }
    ],
    total: 24.00, status: 'Dispensed'
  },
  {
    id: 'PO002', patientId: 'P002', patientName: 'Priya Sharma', doctorId: 'D003',
    doctorName: 'Dr. Rahul Verma', date: '2025-07-05',
    medicines: [
      { medicineId: 'M002', medicineName: 'Amoxicillin 500mg', quantity: 21, price: 0.28, total: 5.88 },
      { medicineId: 'M003', medicineName: 'Paracetamol 500mg', quantity: 20, price: 0.08, total: 1.60 }
    ],
    total: 7.48, status: 'Dispensed'
  },
  {
    id: 'PO003', patientId: 'P003', patientName: 'Rohit Singh', doctorId: 'D002',
    doctorName: 'Dr. Priya Iyer', date: '2025-07-14',
    medicines: [
      { medicineId: 'M008', medicineName: 'Sumatriptan 50mg', quantity: 9, price: 3.80, total: 34.20 }
    ],
    total: 34.20, status: 'Pending'
  },
  {
    id: 'PO004', patientId: 'P004', patientName: 'Ananya Gupta', doctorId: 'D005',
    doctorName: 'Dr. Neha Kapoor', date: '2025-07-16',
    medicines: [
      { medicineId: 'M003', medicineName: 'Paracetamol 500mg', quantity: 30, price: 0.08, total: 2.40 }
    ],
    total: 2.40, status: 'Pending'
  },
];

export const revenueData = [
  { month: 'Jan', revenue: 48500, expenses: 32000, patients: 124 },
  { month: 'Feb', revenue: 52300, expenses: 34500, patients: 138 },
  { month: 'Mar', revenue: 61200, expenses: 38000, patients: 156 },
  { month: 'Apr', revenue: 55800, expenses: 35200, patients: 142 },
  { month: 'May', revenue: 67400, expenses: 41000, patients: 168 },
  { month: 'Jun', revenue: 72100, expenses: 43500, patients: 185 },
  { month: 'Jul', revenue: 69800, expenses: 42000, patients: 178 },
];
